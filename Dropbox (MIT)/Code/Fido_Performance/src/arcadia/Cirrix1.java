...
/*            		double purchaseTarget = Double.parseDouble(args[0]);
		...
		boolean watchForNew = true;
               ...
               creditModel.put(36, "LEVEL_" + args[4].substring(args[4].length()-1));         
               creditModel.put(60, "LEVEL_" + args[5].substring(args[5].length()-1));         
//                creditModel.put(60, "LEVEL_2");
                if (args[1].equals("Y")){
			watchForNew = true;
		}else if (args[1].equals("N")){
			watchForNew = false;
		}
		boolean isWholeValid=false, isFractionalValid=false;
		if (args[2].equals("W")){
			isWholeValid=true;
			isFractionalValid=false;
		} else if (args[2].equals("F")){
			isWholeValid=false;
			isFractionalValid=true;
		} else if (args[2].equals("A")) {
			isWholeValid=true;
			isFractionalValid=true;
		}
		boolean is36Valid=false, is60Valid=false;
		if (args[3].equals("3")){
			is36Valid=true;
			is60Valid=false;
