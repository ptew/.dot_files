...
curl -i -w "@curl-to-csv.txt" -o output/show-all-test.txt -s -H "Accept: text/plain" -H "Authorization: xO5Ae0FwNxXciC4XPzLH6kt3U0A=" -H "Connection: keep-alive" https://api-sandbox.lendingclub.com/api/investor/v1/loans/listing?showAll=true
# for i in `seq 1 1`;
# do
#   curl -i -w "@curl-to-csv.txt" -o output/show-all-test.txt -s -H "Accept: text/plain" -H "Authorization: xO5Ae0FwNxXciC4XPzLH6kt3U0A=" -H "Connection: keep-alive" https://api-sandbox.lendingclub.com/api/investor/v1/loans/listing?showAll=false 
#   sleep 1
# done
